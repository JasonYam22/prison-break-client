    ...
    >
      ...
      <form onSubmit={handleSubmitButton} className="space-y-1">
        ...
        <div className="flex justify-center">
          <button
            className=" border border-black pl-12 pr-12 pt-2 pb-2 mt-4 hover:bg-green-300 bg-green-500 rounded-3xl text-2xl transition-all duration-300 hover:scale-110"
            type="submit"
          >
            Submit
          </button>
